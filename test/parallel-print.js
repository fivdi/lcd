/**
 * Call asynchronous print twice in succession to print 80 characters. The
 * output from the two calls should be interlaced as print is asynchronous.
 */
var Lcd = require('../lcd'),
...
lcd.on('ready', function () {
  lcd.print(Array(81).join('a'));
  lcd.print(Array(81).join('b'));
});
